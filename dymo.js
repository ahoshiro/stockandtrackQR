console.log("window string is "+ window.location.search);
    ...
    function onload()
    {
        ...
        printButton.onclick = function()
        {
            try
            {
                ...
                barcodeLabel.setObjectText("Text", description); //change it with the description variable here. Just temporary. 

                barcodeLabel.setObjectText("Title Text", category); //change it with the real Container value here variable
